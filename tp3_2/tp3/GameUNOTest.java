...
//        // Ejemplo para jugar la primera carta que el jugador actual tenga y pueda jugar
//        Carta cartaParaJugar = juego.getCurrent().mano.peekFirst(); // O algún método para obtener carta
//        juego.playTurn(cartaParaJugar);
//// se salta Bob
