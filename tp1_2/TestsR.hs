...
testNewRempty :: Test
testNewRempty = TestCase (assertEqual "Si se puede crear una nueva Route vacia" (Rou []) (newR []))

testNewR1 :: Test
testNewR1= TestCase (assertEqual "Si se puede crear una nueva Route" (Rou ["dublin", "belfast", "derry"]) (newR ["dublin", "belfast", "derry"]))
...
testNewR2 :: Test
testNewR2 = TestCase (assertEqual "Si se puede crear una nueva Route" (Rou ["dublin", "dublin", "derry"]) (newR ["dublin", "dublin", "derry"]))

testNewR3 :: Test
testNewR3 = TestCase (assertEqual "Si se puede crear una nueva Route" (Rou ["dublin", "derry", "dublin"]) (newR ["dublin", "derry", "dublin"]))
